...
Nossas APIs permitem integração perfeita com clientes externos, através de [Webhooks](/docs/docs/13-notificacoes.md). Os detalhes de Integração estão disponível na [Seção Notifications](/docs/category/notification-webhook)
