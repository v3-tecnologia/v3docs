...
- O **V3HW** deve ser instalado no **pára-brisa do veiculo**, porém deve se atentar ao retrovisor e quebra sol, esses não podem obstruir a visão da lente da câmera interna.
