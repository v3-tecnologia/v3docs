...
- [JC400P](#jc400p)
  ...
  - [Conhecendo o V3HW](#conhecendo-o-v3hw)
    - [Itens que acompanham o V3HW:](#itens-que-acompanham-o-v3hw)
  ...
  - [Passo a Passo de Instalação](#passo-a-passo-de-instalação)
    - [1. Identificação dos Pontos Elétricos](#1-identificação-dos-pontos-elétricos)
      - [**T30 – Positivo Direto**](#t30--positivo-direto)
      - [**T15 – Pós-Chave**](#t15--pós-chave)
      - [**GND – Aterramento**](#gnd--aterramento)
    - [2. Posicionamento do Equipamento](#2-posicionamento-do-equipamento)
    - [3. Conexão dos Fios](#3-conexão-dos-fios)
    - [4. Instalação da Bateria de Backup](#4-instalação-da-bateria-de-backup)
    - [5. Passagem dos Chicotes](#5-passagem-dos-chicotes)
    - [6. Fixação no Para-brisa](#6-fixação-no-para-brisa)
    - [7. Ligação Final e Processo de Boot](#7-ligação-final-e-processo-de-boot)
...
### 1. Identificação dos Pontos Elétricos
...
### 4. Instalação da Bateria de Backup
...
### 7. Ligação Final e Processo de Boot
