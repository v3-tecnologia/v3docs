...
2. 🖼️ **Preparação** - Realiza uma série de pré-processamentos para o evento em questão. Por exemplo, fazer o CROP de uma face específica na media ou gerar um thumbnail que será disponibilizado.
...
3. ☁️ Este evento chega até a **V3CLOUD** pelo contexto de `Events`;
4. 🔄 O contexto de `Events` publica este evento para o contexto de `Vision`;
5. 📋 Processa-se a **Fase 1 - Consolidação**;
6. 🛠️ Processa-se a **Fase 2 - Preparação**;
7. ⚙️ Processa-se a **Fase 3 - Pipeline**;
