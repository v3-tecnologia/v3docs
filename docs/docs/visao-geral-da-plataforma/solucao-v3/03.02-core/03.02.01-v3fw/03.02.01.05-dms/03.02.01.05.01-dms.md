...
- **Considerar o contexto**: As regras só são aplicadas quando o veículo está em movimento (acima de 20 km/h)
...
- O veículo é considerado em movimento se a velocidade for superior a **20 km/h** (`MOVING_MIN_SPEED`).
