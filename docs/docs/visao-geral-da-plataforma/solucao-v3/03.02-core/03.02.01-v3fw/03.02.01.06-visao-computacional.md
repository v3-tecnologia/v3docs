...
Recomenda-se a leitura da [Sessão de Visão](/docs/docs/integracao-e-operacao/ap/visoes), que mostra em detalhes como está definido o nosso motor de Visão na **V3CLOUD**.