...
1. 🛠️ **Hardware**: Eventos relacionados ao automóvel (ex: ignição)
2. 👁️ **Vision**: Eventos capturados pelas câmeras
3. 📡 **Telemetry**: Eventos obtidos via sensores do dispositivo (ex: Giroscópio, GPS)

## 🗂️ Estrutura de um Evento
...
#### 🖼️ Dados de Mídia (quando aplicável)
...
## 🖼️ Recuperando Mídias dos Eventos
