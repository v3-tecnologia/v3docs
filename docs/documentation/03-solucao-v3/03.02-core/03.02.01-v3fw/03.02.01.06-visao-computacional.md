...
3. ☁️ **Envio para a Nuvem**: Essa face é enviada para a Nuvem.
...
- 🛡️ **Maior Segurança**: Apenas motoristas autorizados podem operar o veículo
...
Recomenda-se a leitura da [Sessão de Visão](/docs/documentation/vision), que mostra em detalhes como está definido o nosso motor de Visão na **V3CLOUD**.