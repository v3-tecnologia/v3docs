...
- ➡️ **Longitudinal (X)**: Responsável por detectar movimentos para frente e para trás (acelerações e frenagens)
- ↔️ **Lateral (Y)**: Responsável por detectar movimentos laterais (curvas)
- ⬆️ **Vertical (Z)**: Responsável por detectar movimentos para cima e para baixo (capotamentos)
...
| 🏎️ **Curva Inadequada** | Curvas perigosas para a esquerda ou direita | Lateral (Y) |
...
- 🗺️ **Dados do GPS**: Determinam a localização exata e a velocidade do veículo
...
- 🛡️ **Melhoria da Segurança**: Identificação de condutores com padrões de condução arriscados
...
- ⚠️ **Prevenção de Acidentes**: Alertas em tempo real para comportamentos de risco
...
- 👁️ Complemento às informações do DMS para uma visão completa do condutor 