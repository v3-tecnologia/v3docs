...
- 👨‍✈️ **Comportamento do Condutor**: Detecção de padrões de condução e situações de risco
- 👁️ **DMS**: Monitoramento dos movimentos faciais do condutor para detecção de fadiga, distração entre outros
