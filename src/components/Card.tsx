...
export const Card = ({
  ...
  const cardContent = (
    <div
      className={`relative rounded-3xl shadow-lg p-7 pt-8 transition-colors duration-200 ${bgColor} ${textColor} ${className} min-h-[300px] flex flex-col group hover:bg-primary hover:text-white cursor-pointer`}
