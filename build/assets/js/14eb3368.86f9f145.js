  ...
  [6969],
  {
    11865: (e, t, n) => {
      ...
      var s = n(34164),
        ...
        r = n(74848);
      function i(e) {
        const { permalink: t, title: n, subLabel: i, isNext: l } = e;
    ...
    15833: (e, t, n) => {
      ...
      const m = {
        unreleased: function (e) {
          ...
          return (0, u.jsx)(i.default, {
            ...
            children:
              "This is unreleased docs for {siteTitle} {versionLabel} version.",
          });
        },
        unmaintained: function (e) {
          ...
          return (0, u.jsx)(i.default, {
            ...
            children:
              "This is docs for {siteTitle} {versionLabel}, which is no longer actively maintained.",
          });
        },
      };
      function h(e) {
      ...
      function b(e) {
        ...
        return (0, u.jsx)(i.default, {
          ...
          children:
            "For up-to-date docs, see the {latestVersionLink} ({versionLabel}).",
        });
      }
      function f(e) {
        ...
        const {
          ...
          { pluginId: i } = (0, l.useActivePlugin)({ failfast: !0 }),
          { savePreferredVersionName: d } = (0, c.g1)(i),
          { latestDocSuggestion: m, latestVersionSuggestion: f } = (0,
          l.useDocVersionSuggestions)(i),
          x = m ?? (p = f).docs.find((e) => e.id === p.mainDocId);
        var p;
        return (0, u.jsxs)("div", {
          className: (0, s.A)(
            t,
          ...
          children: [
            (0, u.jsx)("div", {
              children: (0, u.jsx)(h, { siteTitle: r, versionMetadata: n }),
            }),
            (0, u.jsx)("div", {
              className: "margin-top--md",
              children: (0, u.jsx)(b, {
                versionLabel: f.label,
                to: x.path,
                onClick: () => d(f.name),
              }),
            }),
      ...
      function x(e) {
        ...
        const n = (0, d.r)();
        return n.banner
          ? (0, u.jsx)(f, { className: t, versionMetadata: n })
          : null;
      }
    },
    43600: (e, t, n) => {
    ...
    57519: (e, t, n) => {
      ...
      function x(e) {
        let { children: t, active: n, index: a, addMicrodata: r } = e;
        return (0, d.jsxs)("li", {
          ...(r && {
            itemScope: !0,
    ...
    67981: (e, t, n) => {
      ...
      function b(e) {
        ...
        return (0, h.jsx)(l.default, {
          href: t,
          className: (0, i.A)("card padding--lg", m.cardContainer),
          children: n,
        });
      }
      function f(e) {
        let { href: t, icon: n, title: s, description: a } = e;
        return (0, h.jsxs)(b, {
          href: t,
          children: [
            (0, h.jsxs)(u.default, {
              as: "h2",
              className: (0, i.A)("text--truncate", m.cardTitle),
              title: s,
              children: [n, " ", s],
            }),
            a &&
              (0, h.jsx)("p", {
                className: (0, i.A)("text--truncate", m.cardDescription),
                title: a,
                children: a,
              }),
          ],
        ...
        return (0, h.jsxs)("div", {
          ...
          children: [
            ...
            (0, h.jsx)("article", {
              ...
              children: (0, h.jsx)(j, { items: n.items, className: T.list }),
            }),
            (0, h.jsx)("footer", {
              className: "margin-top--lg",
      ...
      function w(e) {
        return (0, h.jsxs)(h.Fragment, {
          children: [(0, h.jsx)(A, { ...e }), (0, h.jsx)(y, { ...e })],
        });
      }
    },
    81430: (e, t, n) => {
              ...
              s.length > n.pluralForms.length &&
                console.error(
                  `For locale=${n.locale}, a maximum of ${
                    ...
                    ","
                  )}), but the message contains ${s.length}: ${e}`
                );
              const a = n.select(t),
                r = n.pluralForms.indexOf(a);
